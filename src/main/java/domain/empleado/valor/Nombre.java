...
public class Nombre implements ValueObject<domain.empleado.valor.Nombre.Props> {
    ...
    @Override
    public domain.empleado.valor.Nombre.Props value() {
        return new domain.empleado.valor.Nombre.Props() {
            @Override
