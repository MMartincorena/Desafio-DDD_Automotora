...
public class EliminarVehiculo extends Command {
    ...
    public EliminarVehiculo(VehiculoId vehiculoId, Marca marca, Caracteristicas caracteristicas, Valor_Mercado valor_mercado, Matricula matricula, Kilometraje kilometraje, Anio anio, Estado estado, Precio precio) {
