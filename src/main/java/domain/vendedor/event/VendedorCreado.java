...
public class VendedorCreado extends DomainEvent {
    ...
    public VendedorCreado(VendedorId vendedorId, Sucursal_Ventas sucursal_ventas, Medio_Cobro medio_cobro, Historial historial, Nombre nombre, Documento documento, Direccion direccion) {
        super("sofka.vendedor.crearcendedor");
